...
public class OrderControllerTest {
    ...
    public void shouldGetPlacedOrderDetails() throws Exception {
        ...
        final OrdersEntity orderEntity = getOrdersEntity(customerEntity);
        ...
        assertEquals(customerOrderResponse.getOrders().get(0).getId().toString(), orderEntity.getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getCustomer().getId().toString(),
                orderEntity.getCustomer().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getId().toString(),
                orderEntity.getAddress().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(),
                orderEntity.getAddress().getStateEntity().getUuid());
    ...
    public void shouldGetCouponByName() throws Exception {
        ...
        when(mockOrderService.getCouponByName("myCoupon", "token")).thenReturn(couponEntity);
        ...
        verify(mockCustomerService, times(1)).getCustomer("database_accesstoken2");
        verify(mockOrderService, times(1))
                .getCouponByName("myCoupon", "token");
    }
    ...
    public void shouldNotGetCouponByNameIfItDoesNotExists() throws Exception {
        ...
        when(mockOrderService.getCouponByName("myCoupon", "token"))
    ...
    private OrdersEntity getOrdersEntity(final CustomerEntity customerEntity) {
