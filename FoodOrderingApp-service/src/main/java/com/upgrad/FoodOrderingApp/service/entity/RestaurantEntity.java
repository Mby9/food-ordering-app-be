...
@NamedQueries(
        {
                ...
                @NamedQuery(name = "findByName",
                        query = "select r from RestaurantEntity  r where lower(r.restaurantName) " +
                                "like :restaurantName order by r.restaurantName"),
                @NamedQuery(name = "findRestaurantByUUId",
                        query = "select r from RestaurantEntity r where lower(r.uuid) = :restaurantUUID")
        }
)
