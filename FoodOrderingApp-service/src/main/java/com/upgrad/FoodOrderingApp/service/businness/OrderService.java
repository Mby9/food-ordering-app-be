...
public class OrderService {
    ...
    public OrdersEntity saveOrder(final SaveOrderRequest saveOrderRequest, final String authorizationToken)
        ...
        CustomerEntity customerEntity = authService.authorizeToken(authorizationToken);
        ...
        CustomerAddressEntity customerAddressEntity = customerAddressDao.getCustAddressByCustIdAddressId(customerAuthEntity.getCustomerEntity(), addressEntity);
